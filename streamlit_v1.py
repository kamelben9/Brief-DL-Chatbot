...
with col1:
    st.image('//home/apprenant/Brief-DL-Chatbot/logo.png', width=60)
with col2:
    st.title("Bank'Bot")
...
st.text_input("Posez votre question au conseiller virtuel", key="input_text", on_change=generate_answer)
